...
export function handleMembershipExtended(event: MembershipExtended): void {
  ...
  //
  // - contract.getBackendPubKey(...)
  // - contract.getBasePricePerDay(...)
  // - contract.getPcWallet(...)
  // - contract.costToExtend(...)
  // - contract.adminMint(...)
  // - contract.balanceOf(...)
  // - contract.checkNameExists(...)
  // - contract.getAddressToName(...)
  // - contract.getApproved(...)
  // - contract.getGeistID(...)
  // - contract.isApprovedForAll(...)
  // - contract.name(...)
  // - contract.ownerOf(...)
  // - contract.redeemInvite(...)
